    ...
    <div className="min-h-screen bg-[var(--dash-bg)] text-[var(--dash-text)] sentinel-theme-v2 flex flex-col justify-between relative overflow-hidden">
      ...
      <header className="relative z-10 max-w-4xl mx-auto w-full px-6 py-6 flex items-center justify-between border-b border-[var(--dash-border)]">
        <Link href="/" className="flex items-center gap-3 group">
          <div className="flex size-10 items-center justify-center rounded-xl border border-[var(--dash-accent)]/20 bg-[var(--dash-accent)]/5 overflow-hidden">
        ...
        <Link href="/login" className="text-xs font-bold uppercase tracking-wider text-[var(--dash-muted)] hover:text-[var(--dash-accent)] transition-colors">
          Console Login
        </Link>
      </header>
      ...
      <main className="relative z-10 flex-1 max-w-md mx-auto w-full px-6 flex flex-col justify-center py-12">
        ...
        >
          {/* Badge Icon */}
          <div className="mx-auto size-14 rounded-2xl border border-[var(--dash-accent)]/20 bg-[var(--dash-accent)]/5 flex items-center justify-center shadow-[0_0_30px_rgba(16,185,129,0.05)]">
            <ShieldCheck size={28} className="text-[var(--dash-accent)] animate-pulse" />
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-[var(--dash-muted)] leading-relaxed max-w-sm mx-auto">
          ...
          <form onSubmit={handleSearch} className="space-y-4">
            <div className="relative group">
              <Search className="absolute left-4 top-1/2 -translate-y-1/2 size-4 text-[var(--dash-muted)] group-focus-within:text-[var(--dash-accent)] transition-colors" />
              <input
                type="text"
                value={caseId}
                ...
                required
                className="w-full h-12 pl-11 pr-4 bg-[var(--dash-card)] border border-[var(--dash-border)] rounded-xl text-sm font-mono placeholder:text-[var(--dash-muted)]/50 focus:outline-none focus:border-[var(--dash-accent)]/50 focus:bg-white transition-all text-[var(--dash-text)]"
              />
            </div>
            <button
              type="submit"
              disabled={!caseId.trim()}
              className="w-full h-12 bg-[var(--dash-accent)] hover:bg-[var(--dash-accent)]/95 disabled:opacity-50 disabled:pointer-events-none text-white font-bold rounded-xl transition-all shadow-[0_0_25px_rgba(16,185,129,0.1)] hover:shadow-[0_0_30px_rgba(16,185,129,0.2)] flex items-center justify-center gap-2 group cursor-pointer"
            >
