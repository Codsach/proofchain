    ...
    <div className="w-full space-y-10 pb-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="space-y-6">
              ...
              {/* Public Verification / Sharing controls card */}
              <motion.div 
              ...
              >
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-dash-muted font-medium">Distribute this secure link for third-party blockchain validation protocol.</p>
                </div>
                <div className="flex items-center justify-between gap-4 pt-2 border-t border-dash-border/50">
                  <motion.a
                    whileHover={{ x: 5 }}
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={handleShare}
                    className="flex items-center justify-center size-8 rounded-full bg-dash-hover hover:bg-[var(--dash-border)]/50 text-dash-accent transition-colors"
