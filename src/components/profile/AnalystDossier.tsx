  ...
  return (
    <Tabs defaultValue="overview" className="w-full mt-6">
      <TabsList className="bg-[var(--dash-card)] border border-[var(--dash-border)] rounded-sm p-1 grid w-full grid-cols-2 md:w-[400px]">
        <TabsTrigger value="overview" className="font-mono uppercase text-xs rounded-sm data-[state=active]:bg-[var(--dash-bg)] data-[state=active]:text-cyan-500">
          Analysis Overview
        </TabsTrigger>
        <TabsTrigger value="log" className="font-mono uppercase text-xs rounded-sm data-[state=active]:bg-[var(--dash-bg)] data-[state=active]:text-cyan-500">
          Cryptographic Log
        </TabsTrigger>
      </TabsList>
      ...
      <TabsContent value="overview" className="mt-6 space-y-6">
        <div className="grid gap-6 md:grid-cols-2">
          <Card className="bg-[var(--dash-card)] border-[var(--dash-border)] rounded-sm">
            ...
            <CardContent>
              <div className="text-4xl font-bold text-[var(--dash-text)] font-mono">{stats.pendingReviews}</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[var(--dash-card)] border-[var(--dash-border)] rounded-sm">
            ...
            <CardContent>
              <div className="text-4xl font-bold text-[var(--dash-text)] font-mono">{stats.verdictsIssued}</div>
            </CardContent>
          </Card>
        </div>
      </TabsContent>
