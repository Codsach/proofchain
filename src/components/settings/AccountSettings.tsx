...
export function AccountSettings({ user }: { user: { fullName: string; email: string } }) {
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-muted-foreground font-mono text-xs uppercase">Full Name</FormLabel>
 <FormControl>
 <Input
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-muted-foreground font-mono text-xs uppercase">Email Address</FormLabel>
 <FormControl>
